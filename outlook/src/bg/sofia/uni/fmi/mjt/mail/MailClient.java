...
public interface MailClient {
     ...
     * @throws AccountAlreadyExistsException if account with the same name is already present in the client
     ...
     testForIllegalArgs  *
     testForAUserNameTaken *
     testForEmailTaken *
     testAccountSuccessfullyCreated *
     */
     ...
     *                                     for the provided account
     ...
     testDoesNotStartFromInbox *
     testIntermediateMissing *
     testFolderAlreadyExists *
     testWithEnding/ *
     testCreateInboxDir *
     TestFolderWasCreated *
     ...
     *
     ...
     testIntermediateDoNotExist *
     testRuleHasRepetition *
     testRuleIsContradictoryToAnother *
     testRuleIsAppliedToMail *
     testRuleIsNotContradictory *
